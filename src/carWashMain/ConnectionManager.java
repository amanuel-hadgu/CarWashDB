...
public class ConnectionManager {
    ...
    private static final String M_CONN_STRING = "jdbc:mysql://localhost:3306/carwashdb?characterEncoding=UTF-8";
    private static final String S_CONN_STRING = "jdbc:mysql://localhost:3306/carwashdb?characterEncoding=UTF-8";
    private final String H_CONN_STRING = "jdbc:hsqldb:data/carwashdb";
